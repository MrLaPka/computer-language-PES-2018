...
#define IN_CODE_TABLE {\
	...
	IN::PR, IN::SEP, IN::F, IN::F, IN::SEP, IN::F, IN::F, IN::L, IN::SEP, IN::SEP, IN::SEP,  IN::SEP, IN::SEP, IN::SEP, IN::T, IN::SEP,\
	IN::T,  IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T,   IN::T,   IN::F,    IN::SEP, IN::SEP,   IN::SEP, IN::SEP, IN::F,\
	IN::SEP,  IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T,   IN::T,   IN::T,    IN::T,   IN::T,   IN::T,   IN::T, IN::T,\
