...
namespace IT
{
	enum IDDATATYPE { INT = 1, BOOL, STR };			//типы данных идентификаторов
	enum IDTYPE { V = 1, F, P, L, S};	//типы идентификаторов: переменная, функция, параметр, литерал, стандартная функция
	...
	IdTable Build(int size = NULL);	//ёмкость таблицы идентификаторов < TI_MAXSIZE
